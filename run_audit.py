...
# GDP should be averaged (it's an annualized rate)
gdp_final = aggregate_yearly(gdp_obs, mode='average')
# Trade is monthly and should be summed to get the total annual deficit/surplus
...
for year in sorted(gdp_final.keys(), reverse=True):
    # Convert Trade Millions to Billions to match GDP Billions
